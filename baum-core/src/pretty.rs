...
impl<'a> Pretty<'a> {
  ...
  fn c<P, S>(&mut self, e: &CExpr<P, S>) -> &mut Self {
    match &e.0 {
      ...
      CExprF::Pi(_, Vis::Explicit, i, t, _, e, _) => self.s("Π(").i(i).s(": ").c(t).s(") ").c(e),
      ...
      CExprF::Pi(_, Vis::Implicit, i, t, _, e, _) => self.s("Π{").i(i).s(": ").c(t).s("} ").c(e),
